...
Options:
    ...
    --output=<file>       Output JSON file [default: std_dicts.json]
"""
...
def generate_std_values(model_name, output_file):
    ...
    from std_dicts import std_dict as ref_std_dict
    from std_dicts import std_bos_dict as ref_std_bos_dict
