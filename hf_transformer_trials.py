...
def replace_layernorm_with_fake_layernorm(model, std):
    ...
    model.transformer.ln_f = FakeLayerNorm(ndim=n_embd, layer=f'blocks.11.hook_resid_post', bias=model.transformer.ln_f.bias is not None)
...
# %%
import wandb
wandb.init(project="hf-transformer-removal")
trainer.train()
wandb.finish()
# %%
