...
for PROMPTS_SET in range(0, 30):
    prompts_and_answers = pickleload(f"/workspace/removing-layer-norm/mech_interp/attribution_patching/data/prompts_{PROMPTS_SET}/prompts.pkl")
    ...
    for MODEL_NAME in ['baseline', 'vanilla', 'noLN']: 
        ...
        store_location = f"/workspace/removing-layer-norm/mech_interp/attribution_patching/data/prompts_{PROMPTS_SET}/new_resid_pre_act_patch_result_{MODEL_NAME}.pkl"
        ...
        store_location = f"/workspace/removing-layer-norm/mech_interp/attribution_patching/data/prompts_{PROMPTS_SET}/new_resid_pre_attr_patch_result_{MODEL_NAME}.pkl"
